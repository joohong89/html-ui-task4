...
*/
var products_url = "http://localhost:31090/products/products/";

var inventory_url = "http://localhost:31090/inventory/inventory/";

var customer_login_url = 'http://localhost:31090/customers/login/'

var customer_url = 'http://localhost:31090/customers/customer/'

var cart_url = 'http://localhost:31090/cart/api/'
    ...
    */
    function checkout(e){
      ...
      console.log(sessionStorage.products);
		...
		var total = parseFloat(document.getElementById("total").innerHTML.replace('SGD ', ''));

		var req = 
		   {
			id: 0, // TODO: not sent to backend at this point in time
			total: total,
			orderId: 0, // TODO: no orderid at this point in time
		...
		products.forEach(item => {
			...
			//TODO: did not cater quantity at backend 
			req.products.push({
